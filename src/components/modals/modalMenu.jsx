...
const ModalMenu = () => {
  ...
  return (
  <>
    <aside className="modalContainer" onClick={() => dispath(closeModalMenu())} >
        ...
        <article className="menu1 article-one">
          <div className="imgContainer">
            <div className="gradientImg"></div>
              <img src="https://images.pexels.com/photos/2014693/pexels-photo-2014693.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt=""/>
          </div>
...
{/* ----------------------------- */ }
        ...
        <article className="menu2 article-one">
          <div className="imgContainer">
            <div className="gradientImg"></div>
            <img src="https://images.pexels.com/photos/2693448/pexels-photo-2693448.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt=""/>
          </div>
          <div className="menuModalInfo">
            <h3>Tarts</h3>
            { 
...
{/* ----------------------------- */ }
        <article className="menu3 article-one">
          <div className="imgContainer">
            <div className="gradientImg"></div>
            <img src="https://images.pexels.com/photos/1190165/pexels-photo-1190165.jpeg" alt=""/>
          </div>
          <div className="menuModalInfo">
            <h3>Drinks</h3>
            { 
...
{/* ----------------------------- */ }
        <article className="menu4 article-two">
          <div className="imgContainer">
            <div className="gradientImg"></div>
            <img src="https://images.pexels.com/photos/4916558/pexels-photo-4916558.jpeg" alt=""/>
          </div>
          <div className="menuModalInfo">
            <h3>Boulangerie</h3>
            { 
...
{/* ----------------------------- */ }
        <article className="menu5 article-two">
          <div className="imgContainer">
            <div className="gradientImg"></div>
            <img src="https://images.pexels.com/photos/3081657/pexels-photo-3081657.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt=""/>
          </div>
          <div className="menuModalInfo">
            <h3>Pettit</h3>
            { 
  ...
  {/*----------------------------------------*/}
        ...
        <article className="menu6 article-two">
          <div className="imgContainer">
            <div className="gradientImg"></div>
            <img src="https://images.pexels.com/photos/8365696/pexels-photo-8365696.jpeg" alt=""/>
          </div>
          <div className="menuModalInfo">
            <h3>Eclairs</h3>
            { 
  ...
  {/*.-----------------------------------------------*/}
        <article className="menu7 article-two">
          <div className="imgContainer">
            <div className="gradientImg"></div>
            <img src="https://images.pexels.com/photos/827516/pexels-photo-827516.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt=""/>
          </div>
          <div className="menuModalInfo">
            <h3>Cakes</h3>
            { 
